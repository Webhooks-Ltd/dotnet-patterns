...
- Business rules are complex enough to warrant a domain model (use LAY-002 or LAY-003)
- Multiple teams need to work on the same codebase without stepping on each other (use FTR-001 or FTR-002)
...
- The service layer is growing beyond ~500 lines per service — that's a signal to graduate to LAY-002
