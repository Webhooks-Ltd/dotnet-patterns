...
> **Ref:** `DOM-001` | **Category:** Domain-centric
...
- If you'd use the same pattern as Full Clean Architecture (LAY-003) — hexagonal and clean architecture overlap significantly. The difference is emphasis: hexagonal focuses on the domain's relationship with the outside world through explicit ports; clean architecture focuses on dependency direction between layers. Choose one mental model, not both.
