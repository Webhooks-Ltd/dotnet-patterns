...
- **[Structural](patterns/structural/)** — How to organise a .NET solution at the project and folder level.
- **[Topology](patterns/topology/)** — System-level patterns defining deployable units, boundaries, and inter-service communication.
- **[Design](patterns/design/)** — Cross-cutting design patterns that layer on top of structural patterns.
